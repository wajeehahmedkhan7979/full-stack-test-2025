...
export default function SignupPage() {
  ...
  const { signUp, signInWithGoogle, signInWithGithub, isAuthenticated, loading: authLoading } = useAuthContext();
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0a0a0a] px-4">
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="rounded-xl border border-zinc-800/60 bg-[#111111] p-6">
          <h2 className="text-base font-medium text-zinc-200 mb-1 text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              <input
                ...
                className="mt-0.5 h-4 w-4 rounded border-zinc-700 bg-zinc-800 accent-[#EF5350]"
              />
              <label htmlFor="accept-terms" className="text-xs text-zinc-500 leading-relaxed">
                I accept the{' '}
                <span className="text-zinc-300 underline cursor-pointer">Terms and Conditions</span>
                {' '}and{' '}
            ...
            <button
              ...
              className="w-full rounded-lg bg-[#EF5350] px-4 py-2.5 text-sm font-medium text-white transition-opacity hover:opacity-90 disabled:opacity-50 flex items-center justify-center gap-2"
